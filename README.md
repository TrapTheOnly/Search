...
`⌃Tab` and `⌃⇧Tab` walk the tabs you used last; hold ⌃Tab for their names. `Tab` stays the page's, for moving through a form. `esc` puts away whatever is open. Option-click a link to glance it over the page.
